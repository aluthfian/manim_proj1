...
class PropEuclid12(Scene):
    def construct(self):
        ...
        H = Text("H", font="sans-serif").next_to(titik_H.get_center()+[0.5,-0.1,0], DOWN)
        ...
        self.play(FadeOut(E), FadeOut(F), FadeOut(G), FadeOut(D))
        self.play(FadeOut(titik_E), FadeOut(titik_G), FadeOut(titik_D))
        ...
        sudutsiku = Square(color='#ffc7dd', fill_opacity=0.5, side_length=0.5).move_to(titik_H.get_center()+[0.25,0.25,0])
